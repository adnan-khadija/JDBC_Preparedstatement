...
public class ServiceForm extends javax.swing.JInternalFrame {
    ...
    public void loadServic(){
     ...
     public void updateService(Service s){
         ...
         String req = "UPDATE service SET nom='" + nom+"' where id="+s.getId() ;
        try {
           ...
           st.executeUpdate(req);
            ...
            System.out.println("Erreur de modifier ce service:" +ex.getMessage());
        }
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
       ...
       // String nom = txtNom.getText().toString();
        if(ss.create(new Service(txtNom.getText()))){
    ...
    private void updateServiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateServiceActionPerformed
        // TODO add your handling code here:
         int reponse= JOptionPane.showConfirmDialog(this, "Vollez vous modifier ce service?");
